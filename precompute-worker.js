...
importScripts('./game-contract.js?v=2.32.0');
importScripts('./game-manifest.js?v=2.32.0');
importScripts('./game-registry.js?v=2.32.0');
importScripts('./logical-move.js?v=2.32.0');
importScripts('./queens-logic.js?v=2.32.0');
importScripts('./difficulty-rating.js?v=2.32.0');
importScripts('./queens-difficulty.js?v=2.32.0');
importScripts('./tango-logic.js?v=2.32.0');
importScripts('./tango-difficulty.js?v=2.32.0');
importScripts('./sudoku-logic.js?v=2.32.0');
importScripts('./sudoku-difficulty.js?v=2.32.0');
importScripts('./patches-logic.js?v=2.32.0');
importScripts('./patches-difficulty.js?v=2.32.0');
importScripts('./nonogram-logic.js?v=2.32.0');
importScripts('./nonogram-validation-solver.js?v=2.32.0');
importScripts('./nonogram-difficulty.js?v=2.32.0');
importScripts('./generation-common.js?v=2.32.0');
importScripts('./queens-generator.js?v=2.32.0');
importScripts('./tango-generator.js?v=2.32.0');
importScripts('./sudoku-generator.js?v=2.32.0');
importScripts('./patches-generator.js?v=2.32.0');
importScripts('./nonogram-generator.js?v=2.32.0');
