 ...
 */
const CACHE='quadlud-v2.21.11';
const ASSETS=['./','./index.html','./styles.css?v=2.21.11','./queens-logic.js?v=2.21.11','./tango-logic.js?v=2.21.11','./app.js?v=2.21.11','./precompute-worker.js?v=2.21.11','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
