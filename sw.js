 ...
 */
const CACHE='logic4-v2.2.5';
const ASSETS=['./','./index.html','./styles.css?v=2.2.5','./app.js?v=2.2.5','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
