 ...
 */
const CACHE='quadlud-v2.21.3';
const ASSETS=['./','./index.html','./styles.css?v=2.21.3','./app.js?v=2.21.3','./precompute-worker.js?v=2.21.3','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
