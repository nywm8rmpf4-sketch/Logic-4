 ...
 */
const CACHE='logic4-v2.7.0';
const ASSETS=['./','./index.html','./styles.css?v=2.7.0','./app.js?v=2.7.0','./precompute-worker.js?v=2.7.0','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
