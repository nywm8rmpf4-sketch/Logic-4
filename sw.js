 ...
 */
const CACHE='quadlud-v2.21.4';
const ASSETS=['./','./index.html','./styles.css?v=2.21.4','./app.js?v=2.21.4','./precompute-worker.js?v=2.21.4','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
