 ...
 */
const CACHE='quadlud-v2.21.1';
const ASSETS=['./','./index.html','./styles.css?v=2.21.1','./app.js?v=2.21.1','./precompute-worker.js?v=2.21.1','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
