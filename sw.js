 ...
 */
const CACHE='logic4-v2.6.1';
const ASSETS=['./','./index.html','./styles.css?v=2.6.1','./app.js?v=2.6.1','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
