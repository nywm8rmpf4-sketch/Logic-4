 ...
 */
const CACHE='quadlud-v2.21.17';
const ASSETS=['./','./index.html','./styles.css?v=2.21.17','./queens-logic.js?v=2.21.17','./tango-logic.js?v=2.21.17','./patches-logic.js?v=2.21.17','./app.js?v=2.21.17','./precompute-worker.js?v=2.21.17','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
