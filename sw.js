 ...
 */
const CACHE='quadlud-v2.21.5';
const ASSETS=['./','./index.html','./styles.css?v=2.21.5','./app.js?v=2.21.5','./precompute-worker.js?v=2.21.5','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
