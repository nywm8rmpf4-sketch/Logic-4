 ...
 */
const CACHE='quadlud-v2.21.18';
const ASSETS=['./','./index.html','./styles.css?v=2.21.18','./queens-logic.js?v=2.21.18','./tango-logic.js?v=2.21.18','./patches-logic.js?v=2.21.18','./sudoku-logic.js?v=2.21.18','./app.js?v=2.21.18','./precompute-worker.js?v=2.21.18','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png','./build-info.json','./LICENSE'];
